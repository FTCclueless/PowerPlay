...
//        assert(openCVWrapper != null);
        ...
        TrajectorySequence to = drive.trajectorySequenceBuilder(origin)
                ...
                .addDisplacementMarker(12, () -> {
                    ...
                    robot.startScoringGlobal(new Pose2d(depositPose.getX() + (5 * xSign), depositPose.getY(), depositPose.getHeading()), new Pose2d(24 * xSign,0 * ySign),27.7, xSign * ySign); // 36
                })
...
//        openCVWrapper.stop();
        ...
        robot.startScoringGlobal(to.end(), new Pose2d(24 * xSign,0 * ySign),28.5, xSign * ySign); // 36
        ...
        for (int i = 0; i < cycles; i++) {
            ...
            robot.startScoringGlobal(new Pose2d(toDeposit.end().getX() + 2, toDeposit.end().getY(), toDeposit.end().getHeading()), new Pose2d(23 * xSign,0),27.5, xSign * ySign); // 36
